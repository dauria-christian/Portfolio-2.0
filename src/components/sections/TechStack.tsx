...
export default function TechStack() {
  return (
    <section className="py-24 bg-black relative top-[-1px]">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
               <h2 className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600 mb-6">
                 Technological Arsenal
               </h2>
               <p className="text-gray-400 text-lg mb-8 leading-relaxed">
                 I constantly push the boundaries of what's possible on the web. 
                 My stack is chosen for speed, scalability, and developer experience.
               </p>
